...
void RenderingEngine::Initialize(int width, int height) {
    ELOG("RenderingEngine.cpp %s","Initialize");
    ...
    screenShader = ShaderManager::GetInstance()->CreatShader(ShaderLanguage::GetInstance()->ScreenVertShader(),
                                                             ShaderLanguage::GetInstance()->ScreenFragShader());
