package com.example.dell.growup.main.mine.information;
...
public class InforFragment extends BaseCompFragment {
    ...
    protected View onCreatViewImpl(LayoutInflater inflater, ViewGroup containter, Bundle saveInstanceState) {
        mRootView = (RelativeLayout) inflater.inflate(R.layout.fragment_infor, containter, false);
        initView(mRootView);
        initData();
        return mRootView;
    }
